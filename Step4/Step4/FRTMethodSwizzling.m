...
void FRTSwizzleInstanceMethod(Class class, SEL originalSelector, SEL alternativeSelector)
{
...
void FRTSwizzleClassMethod(Class class, SEL originalSelector, SEL alternativeSelector)
{
